...
public class BeehiveMayhemWithAudio extends Application {
    ...
    MediaPlayer mediaPlayer; // Declare a MediaPlayer for playing audio
    ...
    public void start(Stage primaryStage) {
        ...
        // Load the audio file
        Media audioFile = new Media(new File("mainGoofy.mp3").toURI().toString());
        mediaPlayer = new MediaPlayer(audioFile);

        

        // Set the audio to stop after 3 seconds (adjust as needed)
        mediaPlayer.setOnEndOfMedia(() -> mediaPlayer.stop());

        // Create the title label
        Label titleLabel = new Label("Beehive Mayhem");
        titleLabel.setStyle("-fx-background-color: darkgreen;-fx-font-size: 23px; -fx-font-weight: bold;-fx-text-fill: white;");
        ...
        roundLabel.setStyle("-fx-background-color: darkgreen;-fx-font-size: 24px;-fx-font-weight: bold;-fx-text-fill: white;");

        // Create the lives label
        livesLabel = new Label("Lives : " + lives);
        livesLabel.setStyle("-fx-background-color: darkgreen;-fx-font-size: 24px;-fx-font-weight: bold;-fx-text-fill: white;");
